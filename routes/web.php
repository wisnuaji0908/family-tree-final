...
Route::middleware(['auth', 'can:people', ClaimPeopleMiddleware::class])->group(function () {
    ...
    Route::get('/api/get-family-tree/{id}', [PeopleController::class, 'getFamilyTree']);
    Route::post('/save-diagram-positions', [PeopleController::class, 'saveDiagramPositions']);
    Route::get('/get-diagram-positions', [PeopleController::class, 'getDiagramPositions']);
    // Route::get('/get-parent/{id}', [ParentsPeopleController::class, 'getParent']);
