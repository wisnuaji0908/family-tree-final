...
<head>
    ...
    <title>{{ $setting?->app_name ?? config('app.name') }} - Profile</title>  
...
<body>
    ...
    <div class="button-grid">
        ...
        <a href=" {{ route('landing.edit') }} " type="button" class="btn-box" title="Edit Profile">
            <i class="bi bi-gear"></i>
        </a>
        <a href=" {{ route('landing.change') }} " type="button" class="btn-box" title="Change Password">
            <i class="bi bi-key"></i>
        </a>
