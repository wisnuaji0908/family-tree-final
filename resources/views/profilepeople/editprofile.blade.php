...
<head>
    ...
    <title>{{ $setting?->app_name ?? config('app.name') }} - Update Profile People</title>  
...
<body>
    ...
    <div class="centered-container">
        <div class="content">
            ...
            <form action="{{ route('update.profile.people') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="position-relative">
                        ...
                        <a href="{{ route('people-change-phone') }}" class="btn btn-warning position-absolute top-50 end-0 translate-middle-y">Change Phone Number</a>
                    </div>
                    @error('phone')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
