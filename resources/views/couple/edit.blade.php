            ...
            <div class="card-body">
                ...
                <form action="{{ route('couple.update', $couple->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="married_date" id="married_date" class="form-control" value="{{ $couple->married_date }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <a href="{{ route('couple.index')}}" class="btn btn-danger">Cancel</a>                </form>
            </div>
        </div>
    </div>
