...
<head>
    ...
    <title>{{ $setting?->app_name ?? config('app.name') }} - Edit Couple</title>  
...
<div class="container-fluid">
    <div class="card">
        <form action="{{ route('peoplecouple.update', $couple->id) }}" method="POST">
            ...
            <div class="text-end">
                <a href="{{ route('peoplecouple.index')}}" class="btn bg-gradient-danger" onclick="return confirm('Are you sure you want to cancel? Unsaved changes will be lost.');">
